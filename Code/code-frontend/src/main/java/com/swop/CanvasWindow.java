 ...
 * <p>
 * To use this class, create a subclass, say com.swop.MyCanvasWindow, that overrides
 * methods {@link #paint(Graphics)}, {@link #handleMouseEvent(int, int, int, int)}, and {@link #handleKeyEvent(int, int, char)}, and then launch
 * it from your com.swop.main method as follows:
 *
 * <pre>
 * public static void com.swop.main(String[] args) {
 *     java.awt.EventQueue.invokeLater(() -> {
 *         new com.swop.MyCanvasWindow("My Canvas Window").show();
 *     });
 * }
 * </pre>
 */
